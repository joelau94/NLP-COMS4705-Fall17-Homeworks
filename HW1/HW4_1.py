...
if __name__ == '__main__':
	...
	os.system('python count_freqs.py ner_train.dat.rare_processed > 4_1.txt') # generate count file
	# get_ner_dev_dat() # remove tag from 'ner_dev.key', write into file 'ner_dev.dat'
	# decode() # do tagging (using baseline tagger). Prediction file is 'ner_dev.out'.
